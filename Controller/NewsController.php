...
use Rofil\Simple\ContentBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RofilSimpleContentBundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("RofilSimpleContentBundle:News:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RofilSimpleContentBundle:News')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RofilSimpleContentBundle:News:edit.html.twig")
     */
